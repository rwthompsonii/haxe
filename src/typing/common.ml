...
| ClassCode -> ":classCode",("Used to inject platform-native code into a class",[Platforms [Java;Swift;Cs]; UsedOn TClass])
		| Commutative -> ":commutative",("Declares an abstract operator as commutative",[UsedOn TAbstractField])
| CompilerGenerated -> ":compilerGenerated",("Marks a field as generated by the compiler. Shouldn't be used by the end user",[Platforms [Java;Swift;Cs]])
...
| DynamicObject -> ":dynamicObject",("Used internally to identify the Dynamic Object implementation",[Platforms [Java;Swift;Cs]; UsedOn TClass; Internal])
...
| FunctionCode -> ":functionCode",("Used to inject platform-native code into a function",[Platforms [Cpp;Java;Swift;Cs]])
...
| Meta.Internal -> ":internal",("Generates the annotated field/class with 'internal' access",[Platforms [Java;Swift;Cs]; UsedOnEither[TClass;TEnum;TClassField]])
