...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACK_FRAME("haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/home/ron/haxe/std/haxe/Log.hx",75,0x8ad676ad)
            	HX_STACK_ARG(v,"v")
            	HX_STACK_ARG(infos,"infos")
HXLINE(  75)		Bool _hx_tmp;
HXDLIN(  75)		if (hx::IsNotNull( infos )) {
HXLINE(  75)			_hx_tmp = hx::IsNotNull( ( (::cpp::VirtualArray)(infos->__Field(HX_("customParams",d7,51,18,ed),hx::paccDynamic)) ) );
            		}
            		else {
HXLINE(  75)			_hx_tmp = false;
            		}
HXDLIN(  75)		if (_hx_tmp) {
HXLINE(  76)			HX_VARI( ::String,extra) = HX_("",00,00,00,00);
HXLINE(  77)			{
HXLINE(  77)				HX_VARI( Int,_g) = (int)0;
HXDLIN(  77)				HX_VARI( ::cpp::VirtualArray,_g1) = ( (::cpp::VirtualArray)(infos->__Field(HX_("customParams",d7,51,18,ed),hx::paccDynamic)) );
HXDLIN(  77)				while((_g < _g1->get_length())){
HXLINE(  77)					HX_VARI_NAME(  ::Dynamic,v1,"v") = _g1->__get(_g);
HXDLIN(  77)					_g = (_g + (int)1);
HXLINE(  78)					extra = (extra + (HX_(",",2c,00,00,00) + ::Std_obj::string(v1)));
            				}
            			}
HXLINE(  79)			__trace((::Std_obj::string(v) + extra),infos);
            		}
            		else {
HXLINE(  82)			__trace(v,infos);
            		}
            	}
